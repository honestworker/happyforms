...
Version 1.33.8 changelog:

* Changed: Date fields from dropdowns to html date fields.

= December 15, 2023 =

Version 1.33.7 changelog:

* Fixed: XSS vulnerability on hidden field attributes.
* Fixed: Conditional logic not working properly with a multistep form.

= October 27, 2023 =

Version 1.33.6 changelog:

* Added: Compatibility with PHP 8.
* Fixed: Default choices not selected when field is initially hidden.

= August 3, 2023 =

Version 1.33.5 changelog:
...
* Fixed: File Upload field opening file selector twice.
* Fixed: Fatal error on submit when Slider field is using type range.
* Removed: Media field.

= June 1, 2023 =

Version 1.33.3 changelog:
...
Version 1.33.2 changelog:

* Added: Conditional logic to Heading and Separator field.
* Added: Role capabilities for coupons, integrations, import and export screen.
...
* Changed: License checks have been relaxed so that no submission is lost, even without a valid license key.
...
* Changed: Forms → Submissions screen now displays better contextual links, depending on the nature of the referral URL.
* Fixed: When importing a form without related submissions, read/unread counters were being wrongly carried over.
* Fixed: Spam submissions were leaving the form in a frozen state.
* Fixed: Conditional logic wasn't working on a empty "Redirect to this page address (URL) after submission" control.
* Fixed: "Spam" and "Trash" counters weren't being updated after bulk deletion of submissions.
...
* Changed: Added `happyforms_show_email_submission_links` filter for controlling display of submission management links in emails.
* Fixed: The "Email me a copy of each submission" → "Email subject" control had wrong labeling.
...
* Changed: "Forms" has been reworded to "Submissions" in Media → Library screen "All media items" dropdown.
...
* Changed: Changed: Change "Delete permanently replies and attachments after set number of days" checkbox to "Erase respondent's personal data after set number of days" numeric input under the "Setup" tab of the form builder.
* Changed: Better wording and style fixes in the form builder.
* Fixed: Opt-In Choice field label spacing was off.

= May 10, 2022 =

Version 1.23.2 changelog:
...
Version 1.22.4 changelog:

* Added: "Step Interval" control allows for fine tuning the incrementing interval of Number and Slider fields.
...
Version 1.21.7 changelog:

* Changed: Improved license check system.

= October 6, 2021 =

Version 1.21.6 changelog:
...
Version 1.20.8 changelog:

* Changed: Added filter for customizing Date-Time dropdown placeholders.
* Fixed: Email me a copy of each submission → Email subject control was missing.

= May 19, 2021 =

Version 1.20.7 changelog:
...
* Fixed: Style controls were not refreshing correctly after toggling "Use theme style".
...
Version 1.17.10 changelog:

* Added: New “Delete activity after set number of days” control for automated removal of activity after a set period of time.
...
* Fixed: Email Confirmation → Send Email control wasn't working if form doesn't include an Email address field.
...
* Changed: New `happyforms_extended_privacy_roles` filter for third party roles in Role Capabilities section.
...
* Added: All settings related to integrations are now in a brand new HappyForms → Integrations screen.
...
* Changed: New `happyforms_is_email` filter allows override of core `is_email` function.
* Changed: Text Editor field is now part of Long Answer field and can be enabled by checking its new “Add rich-text editor toolbar” control.
* Changed: Placeholder field was renamed to Text field and is now part of Layout group in fields drawer.
* Changed: “Hide form after submit” control was moved to “Confirm submission” dropdown and is now a new default option.
* Changed: Tooltip icon now displays next to label instead of inside field input and inherits label color.
* Changed: Improved “Disable buttons until required fields are answered” feature to fade out buttons in multi-step forms too.
...
* Fixed: When set to return `false`, `happyforms_logger_enabled` filter wasn't clearing cookies.
...
* Added: Lock or unlock parts of HappyForms for different roles with new Role Permissions settings.
...
* Changed: Replaced "Get my location" and "Fetching…" words in Address part with animated icons.
* Changed: Added `happyforms_logger_enabled` filter for toggling user tracking.
...
* Added: Added support for media in confirmation email content. The editor now allows to add images to email’s content using Add Media button. Other media types can be added as text links.
* Added: Added support for media in Blanks part. This allows for embedding images, videos, and audio files in the part’s content directly.
* Added: Added “Suffix” control to Web Address part.
* Changed: Data received as PDF now follows conditional logic.
* Changed: New “Confirm submission” control in Setup step. Form can be configured to display a confirmation message or redirect to web address on submit.
* Changed: New autocomplete feature in “Redirect to web address” control for adding posts and pages URLs easily by searching in content title as you type.
* Changed: Added “Limit files” checkbox control to Attachment part for specifying maximum number of files accepted by part.
* Changed: Added a new label control to add more description to file counter in Attachment part.
* Changed: Added a new label control for “Limit words/characters” feature in Long Text and Text Editor parts.
* Changed: Compatibility with WordPress 5.4.
* Changed: Various improvements to HappyForms UI.
* Fixed: Incomplete conditions in part’s Logic section could be saved which was leading to errors on front end.
...
* Changed: Added `happyforms_use_async_tasks` filter to toggle async task behavior.
...
* Fixed: Comment count was including HappyForms statistics.
...
* Added: New part — Poll, for collecting opinions and showing published results in a bar chart.
...
= 1.33.7 =
* Fixed: XSS vulnerability on hidden field attributes and conditional logic not working properly with a multistep form.

= 1.33.6 =

* Added PHP compatibility, fixed default choices not selected when field is initilaly hidden, ther miscellaneous bug fixes.
...
* Add new Image, Video and Audio field, fixed special character display issue, fixed File Upload field bug, other miscellaneous bug fixes.

= 1.33.3 =

* Added new email testing tool, new submission resending function, and File Upload field bugfixes.

= 1.33.2 =

* Added role capabilities for integrations, coupon, import and export screen, added conditional logic to Heading and Separator field, removed deprecated HTML code.

= 1.33.1 =
* Allow uppercase characters in limit character/word controls and limit choice labels, miscellaneous bugfixes.

= 1.33.0 =
* New dedicated Forms → Import and Forms → Export screens, relaxed license checks.

= 1.32.0 =
* Slider field improved usability and form block security improvements.

= 1.31.0 =
* Easier handling of submissions containing disallowed words, dashboard notices and Messages tab improvements.

= 1.30.0 = 
* New form importer in Tools → Import screen, better referral links in Submissions screen, miscellaneous bugfixes.

= 1.29.0 =
* Messages tab usability improvements, license checks network issues handling, new email metadata controls, limited choice bugfixes in Radio, Checkbox and Dropdown fields.

= 1.28.2 =
* Changelog improvements, fixes for conditional logic and builder controls, miscellaneous improvements.

= 1.28.1 = 
* Minor improvements and bugfixes.

= 1.28.0 =
* New submission links in emails, better display of unlabeled fields, improved "Save" submission metabox, miscellaneous improvements and bugfixes.

= 1.27.1 =
* Conditional logic and Dropdown field bugfixes.

= 1.27.0 =
* Conditional logic support for Radio, Checkbox and Dropdown choices, "Print my submission" feature, usability improvement, bugfixes.

= 1.26.0 =
* Single-bundle frontend styles for better performance, builder interface improvements, Poll field removal.

= 1.25.0 =
* New "Bulk Add Choices" control for Radio, Checkbox and Dropdown fields, simplified controls in Setup and Email tabs, miscellaneous improvements and bugfixes.
...
= 1.22.4 =
* New "Step Interval" control for Number and Slider field, improved multi-page form navigation, miscellaneous improvements and bugfixes.
...
= 1.20.8 =
* Missing Email me a copy of each submission → Email subject control, Date-Time placeholders filter.
...
= 1.20.2 =
* Searchable dropdowns improvements, better "Limit choices" controls, bugfixes.
...
= 1.17.6 =
* Accessibility and performance improvements, styling bugfixes.
...
= 1.13.0 =
* New Submission Blocklist, Role Permissions settings, improvement and bugfixes.
...
= 1.12.0 =
* reCAPTCHA v3, various improvements and bug fixes.

= 1.11.0 =
* New Settings screen, bug fixes and improvements.
...
= 1.9.5 =
* Choices width control to allow for multi-column layouts in Single Choice and Multiple Choice parts.
