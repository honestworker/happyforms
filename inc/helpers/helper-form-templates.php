...
if ( ! function_exists( 'happyforms_get_datetime_placeholders' ) ) :

function happyforms_get_datetime_placeholders( $component = false ) {
	$placeholders = array(
		'year' => __( 'Year', 'happyforms' ),
		'month' => __( 'Month', 'happyforms' ),
		'day' => __( 'Day', 'happyforms' ),
	);

	$placeholders = apply_filters( 'happyforms_get_datetime_placeholders', $placeholders );
