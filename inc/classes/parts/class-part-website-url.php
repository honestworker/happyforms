...
class HappyForms_Part_WebsiteUrl extends HappyForms_Form_Part {
	...
	public function customize_templates() {
		$template_path = happyforms_get_include_folder() . '/templates/parts/customize-website-url.php';
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		wp_enqueue_script(
			'part-website-url',
			happyforms_get_plugin_url() . 'inc/assets/js/parts/part-website-url.js',
