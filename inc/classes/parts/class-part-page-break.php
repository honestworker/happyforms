...
class HappyForms_Part_PageBreak extends HappyForms_Form_Part {
	...
	public function get_customize_fields() {
		$fields = array(
			...
			'continue_button_label' => array(
				'default' => __( 'Continue', 'happyforms' ),
				'sanitize' => 'sanitize_text_field',
			),
	...
	public function customize_templates() {
		$template_path = happyforms_get_include_folder() . '/templates/parts/customize-page-break.php';
	...
	public function frontend_template( $part_data = array(), $form_data = array() ) {
		...
		include( happyforms_get_include_folder() . '/templates/parts/frontend-page-break.php' );
	}
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		wp_enqueue_script(
			'part-page-break',
			happyforms_get_plugin_url() . 'inc/assets/js/parts/part-page-break.js',
	...
	public function get_form_data( $form ) {
		...
		$global_value = happyforms_get_meta( $form['ID'], 'next_button_label', true );
