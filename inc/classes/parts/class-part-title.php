...
class HappyForms_Part_Title extends HappyForms_Form_Part {
	...
	public function customize_templates() {
		$template_path = happyforms_get_include_folder() . '/templates/parts/customize-title.php';
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		wp_enqueue_script(
			'part-title',
			happyforms_get_plugin_url() . 'inc/assets/js/parts/part-title.js',
	...
	public function script_dependencies( $deps, $forms ) {
		...
		wp_register_script(
			'happyforms-title',
			happyforms_get_plugin_url() . 'inc/assets/js/frontend/title.js',
