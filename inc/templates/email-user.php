...
<?php if ( happyforms_get_form_property( $form, 'confirmation_email_include_values' ) ) : ?>
	...
	<?php foreach( $form['parts'] as $part ) : ?>
		...
		<?php echo happyforms_get_email_part_value( $response, $part, $form, 'user-email' ); ?>
		<br><br>
...
if ( happyforms_capture_client_ip() && ( happyforms_get_form_property( $form, 'confirmation_email_include_submitters_ip' ) ) ) : ?>
