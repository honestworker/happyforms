...
$formatted_date = date('Y-m', $current_timestamp);
	...
	<div class="happyforms-custom-date" data-searchable="true">
		<div class="happyforms-part__date-wrap">
			<div class="happyforms-input">
				<input type="month" min="<?php echo $min_year;?>-01" max="<?php echo $max_year;?>-12" value="<?php echo $current_value;?>" name="<?php happyforms_the_part_name( $part, $form ); ?>[date]" data-serialize required class="happyforms-date-field" />
			</div>
		</div>
	</div>
</div>
