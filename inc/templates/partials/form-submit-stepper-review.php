...
<div class="happyforms-form__part happyforms-part happyforms-part--submit">
	...
	<button type="submit" class="happyforms-submit happyforms-button--submit <?php echo $submit_button_extra_class; ?>" data-step="<?php echo happyforms_get_last_step( $form, true ); ?>"><?php echo esc_attr( happyforms_get_form_property( $form, 'submit_button_label' ) ); ?></button>
