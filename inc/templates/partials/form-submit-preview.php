...
<div class="happyforms-form__part happyforms-part happyforms-part--submit">
    ...
    <button type="submit" class="happyforms-submit happyforms-button--submit <?php echo $submit_button_extra_class; ?>"><?php echo esc_attr( happyforms_get_form_property( $form, 'review_button_label' ) ); ?></button>
